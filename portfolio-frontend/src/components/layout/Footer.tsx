...
export default function Footer() {
  ...
  const socials = [
    ...
    portfolio?.email && { icon: Mail, href: `mailto:${portfolio.email}?subject=🚀 Project Enquiry | Bhavya Portfolio`, label: 'Email' },
  ...
  const displaySocials = socials.length > 0
    ...
    : [
        ...
        { icon: Mail, href: 'mailto:agrawalbhavya563@gmail.com?subject=🚀 Project Enquiry | Bhavya Portfolio', label: 'Email' },
      ];
